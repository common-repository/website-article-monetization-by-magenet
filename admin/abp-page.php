...
<div class="wrap">
	...
	<?php } else { ?>
        <form method="post" id="abp_form_settings">
	        <?php wp_nonce_field( 'abp-update-settings' ); ?>
            ...
            <div>
                <input type="text" name="abp_auth_key" id="abp_auth_key" style="width: 400px" maxlength="32" minlength="1" value="<?php echo sanitize_key($abp_auth_key); ?>" placeholder="Please enter your Authorization Key"/>
            </div>
